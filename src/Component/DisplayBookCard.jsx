...
// console.log(bookId);
    return (
        <Link  to={`/bookDtails/${bookId}`}  className='' >
        <div className="card  bg-base-100 shadow-xl border-2 hover:border-2 hover:border-gray-500 h-[470px]">
          <div className='bg-slate-200 rounded-xl m-3 flex justify-center items-center'>
            <figure className="  h-[200px]  rounded-xl">
